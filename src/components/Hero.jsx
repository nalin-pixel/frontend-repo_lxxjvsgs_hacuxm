...
export default function Hero() {
  ...
  const words = 'Train Hard. Move Smart.'
    .split(' ')
    ...
    <section id="home" className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-6">
        <div className="flex items-center justify-between">
          <a href="#home" className="text-white font-bold text-xl tracking-tight neon-text">PulseGym</a>
          <button onClick={() => setMenuOpen(true)}
            className="p-3 rounded-full bg-white/5 hover:bg-white/10 text-white neon-ring">
            <Menu size={22} />
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center py-24">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-br from-cyan-500/20 to-indigo-500/20 border border-white/10 neon-border">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white/5 backdrop-blur rounded-2xl p-4 border border-white/10 text-white neon-ring">
